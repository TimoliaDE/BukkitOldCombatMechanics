...
/*
 * This matches the old attack range (3.0875 blocks) in 1.8 pvp.
...
public class ModuleOldAttackRange extends OCMModule {
    ...
    private boolean requiresLegacyClients;
    ...
    public void reload() {
        ...
        requiresLegacyClients = module().getBoolean("requiresLegacyClients", false);
    ...
    private void adjustEntityInteractionRange(Player player) {
        ...
        if (requiresLegacyClients && !ViaVersionUtil.isLegacyClientsAllowed()) return;
