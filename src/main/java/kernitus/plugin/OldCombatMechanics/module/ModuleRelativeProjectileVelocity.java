 ...
 */
public class ModuleRelativeProjectileVelocity extends OCMModule {

    public ModuleRelativeProjectileVelocity(OCMMain plugin) {
        super(plugin, "relative-projectile-velocity");
        reload();
    }
